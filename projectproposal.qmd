...
5.  Conduct Geographically Weighted Regression: Building Multiple Linear Regression model and Hedonic Pricing model to predict prices of Airbnb listings. In this case, price will be our response variable and the set of predictors that we will use in our predictive model includes: (Jin Lei)
    -   Neighbourhood,
    -   room_type,
    -   minimum nights,
    -   number of reviews,
