...
1.  Conduct exploratory data analysis and plot a map of Airbnb listings in Singapore to gain an understanding of where Airbnb listings in Singapore are located. (Maaruni)
2.  Conduct first-order spatial point pattern analysis: Deriving Kernel Density Estimation layer for visualizing and exploring the intensity of Airbnb listings in Singapore. (Felicia & Maaruni)
...
5.  Conduct Geographically Weighted Regression: Building Multiple Linear Regression model and Hedonic Pricing model to predict prices of Airbnb listings. Set of predictors we can possibly use in our predictive model include: (Jin Lei)
    -   Neighbourhood,
    -   room_type,
    -   price,
    -   minimum nights,
